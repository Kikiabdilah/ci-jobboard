    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-6 col-lg-3 col-md-6 text-center">
                <img src="<?= base_url('public/assets/images/logo_mailchimp.svg'); ?>" alt="Image"
                    class="img-fluid logo-1">
            </div>
            <div class="col-6 col-lg-3 col-md-6 text-center">
                <img src="<?= base_url('public/assets/images/logo_paypal.svg'); ?>" alt="Image"
                    class="img-fluid logo-2">
            </div>
            <div class="col-6 col-lg-3 col-md-6 text-center">
                <img src="<?= base_url('public/assets/images/logo_stripe.svg'); ?>" alt="Image"
            ...
            <div class="col-6 col-lg-3 col-md-6 text-center">
                <img src="<?= base_url('public/assets/images/logo_tinder.svg'); ?>" alt="Image"
            ...
            <div class="col-6 col-lg-3 col-md-6 text-center">
                <img src="<?= base_url('public/assets/images/logo_airbnb.svg'); ?>" alt="Image"
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 ml-auto align-self-end">
                <img src="<?= base_url('public/assets/images/apps.png'); ?>"
                    alt="Free Website Template by Free-Template.co" class="img-fluid">
            </div>
        </div>
    </div>
