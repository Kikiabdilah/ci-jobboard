...
<section class="section-hero overlay inner-page bg-image"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <h1 class="text-white font-weight-bold">Jobs you applyed to</h1>
                <div class="custom-breadcrumbs">
                    <a href="<?= url_to('home') ?>">Home</a> <span class="mx-2 slash">/</span>
                    <span class="text-white"><strong>Jobs you applyed to</strong></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row mb-5 justify-content-center">
            <div class="col-md-7 text-center">
                <h2 class="section-title mb-2">Jobs you applyed to</h2>
            </div>
        </div>

        <ul class="job-listings mb-5">
            <?php foreach ($applyedJobs as $jobs): ?>
