                ...
                <form action="<?= url_to('submit.profile.users'); ?>" method="POST" class="p-4 border rounded">
                    ...
                    <div class="row form-group">
                        <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <input type="text" name="username" value="<?= $singleUser->username; ?>" id="fname"
                    ...
                    <div class="row form-group mb-4">
                        <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <input type="text" name="job_title" value="<?= $singleUser->job_title; ?>" id="fname"
                    ...
                    <div class="row form-group mb-4">
                        <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <input type="text" name="facebook" value="<?= $singleUser->facebook; ?>" id="fname"
                    ...
                    <div class="row form-group mb-4">
                        <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <input type="text" name="linkedin" value="<?= $singleUser->linkedin; ?>" id="fname"
                    ...
                    <div class="row form-group mb-4">
                        <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <input type="text" name="twitter" value="<?= $singleUser->twitter; ?>" id="fname"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="bio" placeholder="Bio" id="exampleFormControlTextarea1"
                            rows="3"><?= $singleUser->bio; ?></textarea>
                    </div>
